...
export default function TakeQuiz() {
    ...
    /**
     * 
     * Working on displaying all questions to quiz editor screen at same time
     * use map to map all ${quizQuestions} to editor
     * use if quizQuestion.questionType = ["Multiple Choice", "True False", "Fill In The Blank"] 
     * to set up all questions/how they are displayed and their answer fields
     * 
     * 
     */
