    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-lists">
            ...
            My favorite recipe: Turkey Wrap
            <ol id="wd-your-favorite-recipe">
                <li>Get a tomato tortilla.</li>
                <li>Add sliced turkey.</li>
                <li>Add provologne cheese.</li>
                <li>Add lettuce.</li>
                <li>Add sliced onion.</li>
                <li>Add sliced tomato.</li>
                <li>Add chipotle mayo.</li>
                <li>Close the wrap and heat it up.</li>
                <li>Serve and enjoy!</li>
            </ol>
            ...
            <ul id="wd-your-books">
                <li>Heart Stopper The Series</li>
                <li>Aristotle and Dante Discover the Secrets of the Universe</li>
                <li>Aristotle and Dante Dive into the Waters of the World</li>
                <li>The Song of Achillies</li>
                <li>Circe</li>
            </ul>
        ...
        <div id="wd-tables">
            ...
            <tbody>
                ...
                <tr>
                    <td>Q10</td>
                    <td>Fun Facts Trivia Quiz: Extra Credit</td>
                    <td>4/29/21</td>
                    <td>98</td>
                </tr>
            </tbody>
        ...
        <div id="wd-images">
            ...
            <img id="wd-starship" width="400px"
                ...
                alt="Using provided link"
            />
            <br />
                Loading a local image:
            <br />
            <img id="wd-teslabot" src="images/teslabot.jpg" height="200px" alt="Teslabot from local file" />
        </div>
        ...
        <div id="wd-forms">
            ...
            To visit the GitHub link <a id="wd-github" href="https://github.com/mouri-e/kanbas-react-web-app/tree/a1">
            click here</a>
        </div>
